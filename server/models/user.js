...
module.exports = (sequelize, DataTypes) => {
  class User extends Model {
    static associate(models) {
      ...
      User.hasMany(models.Like, { foreignKey: 'LikedUserId', as: 'likesReceived' });

      // Matches where this user is user1
      User.hasMany(models.Match, { foreignKey: 'User1Id', as: 'matchesAsUser1' });

      // Matches where this user is user2
      User.hasMany(models.Match, { foreignKey: 'User2Id', as: 'matchesAsUser2' });
    }
  }
